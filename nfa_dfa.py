...
Incluye interfaz gráfica con visualización de autómatas y estados compuestos legibles.

Uso:
  python nfa_dfa_gui.py input.json
  python nfa_dfa_gui.py input.xml --no-minimize
  python nfa_dfa_gui.py input.xml -o salida.json --out-format json --name MiAFD
  python nfa_dfa_gui.py --gui  # Abrir interfaz gráfica
"""
...
class Automaton:
    def __init__(
        ...
        is_dfa: bool = False,
        name: str = "automaton",
        state_composition: Dict[str, Set[str]] = None,  # Para estados compuestos
    ):
        ...
        self.is_dfa = is_dfa
        self.name = name
        self.state_composition = state_composition or {}  # estado_dfa -> {estados_nfa}
    ...
    def get_readable_state_name(self, state: str) -> str:
        """Retorna el nombre del estado con su composición si está disponible"""
